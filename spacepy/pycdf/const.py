...
# h2py cdf.h (probably need to use Python 2 to capture the Longs)
# Open CDF.py
# remove def lines
...
TT2000_CDF_MAYNEEDUPDATE =  1010
BLOCKINGFACTOR_TOO_SMALL =  1011
BLOCKINGFACTOR_TOO_SMALL2 =  1012
STRING_NOT_UTF8_ENCODING =  1013
BLOCKINGFACTOR_TOO_LARGE =  1014
CDF_OK =  0
...
ZLIB_COMPRESS_ERROR = -2231
ZLIB_UNCOMPRESS_ERROR = -2232
CANNOT_INSERT_RECORDS = -2233
TT2000_USED_OUTDATED_TABLE = -2234
BADDATE_LEAPSECOND_UPDATED = -2235
FUNCTION_NOT_SUPPORTED = -2236
TRY_TO_READ_NONSTRING_DATA = -2237
BAD_NUM_STRINGS = -2238
CANNOT_CONVERT_WIDECHAR = -2239
...
rVAR_RECORDS_RENUMBER_ = ctypes.c_long(157)
zVAR_RECORDS_RENUMBER_ = ctypes.c_long(158)
CDF_LEAPSECONDLASTUPDATED_ = ctypes.c_long(159)
rENTRY_STRINGSDATA_ = ctypes.c_long(160)
zENTRY_STRINGSDATA_ = ctypes.c_long(161)
rENTRY_NUMSTRINGS_ = ctypes.c_long(162)
zENTRY_NUMSTRINGS_ = ctypes.c_long(163)
